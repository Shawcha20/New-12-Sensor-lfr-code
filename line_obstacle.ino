   ...
   if(sum>8 && sum<12 && digitalvalue[0]==1 && digitalvalue[11]==1)
   {
    ...
    if (sum == 3 || sum == 2 || sum == 1) {
      ...
      if (cross != 's')
      {
        ...
        while (digitalvalue[4] + digitalvalue[5] + digitalvalue[6] + digitalvalue[7] > 0 )reading();
    ...
    else if (sum == 8 || sum == 7 || sum == 6)
    {
      if (digitalvalue[11] == 1 && digitalvalue[10] == 1 && digitalvalue[0] == 0 && digitalvalue[1] == 0 && digitalvalue[6] + digitalvalue[5] + digitalvalue[4] > 0)
      {
        ...
        if ((sum == 4 ||sum==3)&& digitalvalue[4] == 1 && digitalvalue[5] == 1 && digitalvalue[6] == 1 && digitalvalue[7] == 1)flag = 's';
        if (side == 'r')
        {
    ...
    else if (sum == 12)
    {
      ...
      else if (sum != 0 && sum != 12) //if cross section detected
      {
        cross = 's';
      }
      else if (sum == 0)
